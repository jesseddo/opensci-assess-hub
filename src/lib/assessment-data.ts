export type ResourceType = "doc" | "form" | "key";

export interface Assessment {
  id: string;
  lesson: string; // e.g. "Lesson 04" or "Final"
  title: string;
  type: string; // e.g. "Mid-unit Formative"
  standards: string[];
  resources: ResourceType[]; // which resources are available
  isSummative?: boolean;
}
...
export interface Unit {
  ...
  title: string;
  description: string;
  lessonCount?: number; // total lessons in the unit (defaults to 8)
...
const a = (
  ...
  type: string,
  standards: string[],
  resources: ResourceType[] = ["doc", "form", "key"],
  isSummative = false,
): Assessment => ({ id, lesson, title, type, standards, resources, isSummative });
...
/** Parse a lesson label like "Lesson 04" -> 4. Returns null for "Final" etc. */
...
export const gradeLevels: GradeLevel[] = [
  {
    ...
    units: [
      u("K.1", "Weather & Sky", "Observe daily and seasonal weather patterns.", [
        ...
        a("k1-2", "Final", "Weather Journal Review", "Summative", ["K-ESS2-1", "K-ESS3-2"], ["doc", "key"], true),
      ]),
      u("K.2", "Pushes & Pulls", "Investigate how forces change motion.", [
        a("k2-1", "Lesson 02", "Ramp Investigation Check", "Formative", ["K-PS2-1"]),
        a("k2-2", "Lesson 05", "Designing a Pull Toy", "Performance Task", ["K-PS2-2"], ["doc", "key"]),
      ]),
      ...
      u("K.4", "Our Earth", "Care for the world around us.", [
        a("k4-1", "Final", "Caring for Earth Project", "Summative", ["K-ESS3-3"], ["doc", "key"], true),
      ]),
    ],
  },
  {
    ...
    units: [
      u("1.1", "Light & Sound", "How light and sound travel.", [
        ...
        a("11-2", "Final", "Communicating with Light", "Summative", ["1-PS4-4"], ["doc", "key"], true),
      ]),
      ...
      u("1.3", "Plants & Animals", "Structures that help survival.", [
        a("13-1", "Lesson 06", "Mimicking Nature", "Performance Task", ["1-LS1-1"], ["doc", "key"]),
      ]),
      u("1.4", "Inheritance", "How offspring resemble parents.", [
        a("14-1", "Final", "Parent & Offspring Match", "Summative", ["1-LS3-1"], undefined, true),
      ]),
    ],
  },
  {
    ...
    units: [
      u("2.1", "Properties of Matter", "Classify materials by their properties.", [
        ...
        a("21-2", "Final", "Designing with Materials", "Performance Task", ["2-PS1-2"], ["doc", "key"], true),
      ]),
      ...
      u("2.4", "Water on Earth", "Where water is found and how it moves.", [
        a("24-1", "Final", "Mapping Water Sources", "Summative", ["2-ESS2-3"], ["doc", "key"], true),
      ]),
    ],
  },
  {
    ...
    units: [
      u("3.1", "Forces & Interactions", "Balanced and unbalanced forces.", [
        ...
        a("31-2", "Final", "Designing a Force Solution", "Summative", ["3-PS2-1", "3-PS2-2"], ["doc", "key"], true),
      ]),
      ...
      u("3.3", "Weather & Climate", "Weather patterns and climate regions.", [
        ...
        a("33-2", "Final", "Severe Weather Solution", "Performance Task", ["3-ESS3-1"], ["doc", "key"], true),
      ]),
  ...
  },
  {
    ...
    units: [
      u("4.1", "Energy Transfer", "Energy in collisions and circuits.", [
        ...
        a("41-2", "Final", "Energy Conversion Device", "Performance Task", ["4-PS3-4"], ["doc", "key"], true),
      ]),
      ...
      u("4.4", "Plant & Animal Structures", "Internal and external structures.", [
        a("44-1", "Final", "Structure & Function Model", "Summative", ["4-LS1-1"], ["doc", "key"], true),
      ]),
    ],
  },
  {
    ...
    units: [
      u("5.1", "Matter & Its Interactions", "Conservation of matter.", [
        ...
        a("51-2", "Final", "Mystery Substance Lab", "Performance Task", ["5-PS1-3"], ["doc", "key"], true),
      ]),
      ...
      u("5.3", "Earth Systems", "Spheres of the Earth and their interactions.", [
        a("53-1", "Final", "Sphere Interaction Map", "Summative", ["5-ESS2-1"], ["doc", "key"], true),
      ]),
  ...
  },
  {
    ...
    units: [
      u("6.1", "One-Way Mirrors", "Light, vision, and information.", [
        ...
        a("61-2", "Final", "Mirror System Design", "Performance Task", ["MS-PS4-2"], ["doc", "key"], true),
      ]),
  ...
  },
  {
    ...
    units: [
      u("7.1", "Chemical Reactions", "Matter transformation.", [
        ...
        a("71-1b", "Lesson 04", "White Powders Progress Tracker", "Progress Tracker", ["MS-PS1-2"], ["doc", "key"]),
        a("71-2", "Lesson 09", "Mid-Unit Assessment", "Summative", ["MS-PS1-1"], ["doc", "key"]),
        a("71-3", "Final", "Flammability & Substance Change", "Performance Task", ["MS-PS1-2"], ["doc", "key"], true),
      ]),
      ...
      u("7.4", "Earth's Resources", "Human impact and sustainability.", [
        a("74-1", "Final", "Resource Use Argument", "Summative", ["MS-ESS3-3"], ["doc", "key"], true),
      ]),
    ],
  },
  {
    ...
    group: "middle",
    units: [
      u("8.1", "Contact Forces", "How forces act during collisions and impacts.", [
        a("81-1", "Lesson 04", "Collision Model Analysis", "Formative", ["MS-PS2-1", "MS-PS2-2"]),
        a("81-1b", "Lesson 04", "Collision Progress Tracker", "Progress Tracker", ["MS-PS2-1"], ["doc", "key"]),
        a("81-2", "Lesson 07", "Magnetic Field Investigation", "Lesson Reflection", ["MS-PS2-3"], ["doc", "key"]),
        a("81-2b", "Lesson 07", "Field Models Exit Ticket", "Exit Ticket", ["MS-PS2-3"], ["doc"]),
        a("81-3", "Final", "Unit 8.1 Performance Task", "Summative Assessment", ["MS-PS2-1", "MS-PS2-2"], ["doc", "form", "key"], true),
      ]),
      u("8.2", "Sound Waves", "Energy and patterns of waves.", [
        a("82-1", "Lesson 05", "Wave Property Check", "Formative", ["MS-PS4-1"]),
        a("82-2", "Final", "Designing a Sound Solution", "Performance Task", ["MS-PS4-2"], ["doc", "key"], true),
      ]),
      u("8.3", "Forces at a Distance", "Magnetic and electric fields.", [
        a("83-1", "Lesson 04", "Field Diagram Check", "Formative", ["MS-PS2-5"]),
      ]),
      u("8.4", "Earth in Space", "Gravity and orbital motion.", [
        a("84-1", "Lesson 06", "Seasons Modeling", "Formative", ["MS-ESS1-1"]),
        a("84-2", "Final", "Solar System Scale Model", "Summative", ["MS-ESS1-3"], ["doc", "key"], true),
      ]),
    ],
  },
  {
    ...
    units: [
      u("B.1", "Ecosystem Dynamics", "Energy flow and matter cycling.", [
        ...
        a("b1-2", "Final", "Carrying Capacity Argument", "Summative", ["HS-LS2-1"], ["doc", "key"], true),
      ]),
      ...
      u("B.3", "Evolution", "Natural selection and common ancestry.", [
        ...
        a("b3-2", "Final", "Evolutionary Evidence Brief", "Performance Task", ["HS-LS4-1"], ["doc", "key"], true),
      ]),
  ...
  },
  {
    ...
    units: [
      u("C.1", "Atomic Structure", "Patterns in the periodic table.", [
        ...
        a("c1-2", "Final", "Periodic Trends Argument", "Summative", ["HS-PS1-2"], ["doc", "key"], true),
      ]),
      ...
      u("C.3", "Thermodynamics", "Energy in chemical change.", [
        ...
        a("c3-2", "Final", "Endothermic Design Task", "Performance Task", ["HS-PS3-3"], ["doc", "key"], true),
      ]),
  ...
  },
  {
    ...
    units: [
      u("P.1", "Forces & Motion", "Newton's laws applied to systems.", [
        ...
        a("p1-2", "Final", "Momentum Collision Lab", "Performance Task", ["HS-PS2-2", "HS-PS2-3"], ["doc", "key"], true),
      ]),
      ...
      u("P.3", "Waves & Electromagnetic Radiation", "Wave behavior and EM spectrum.", [
        ...
        a("p3-2", "Final", "EM Communication Argument", "Summative", ["HS-PS4-2"], ["doc", "key"], true),
      ]),
